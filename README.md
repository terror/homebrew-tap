...
**homebrew-tap** is my personal collection of formulas for [homebrew](https://brew.sh/).
...
search results (e.g. brew search output):
...
name (incl. the `terror/tap/` prefix) when referring to formulae in external taps
such as this one outside of search.
